...
module JtdCodegenE2e
  ...
  class Root
    ...
    def self.from_json(data)
      out = Root.new
      out.value = JtdCodegenE2e.from_json(GeojsonObject, data)
      out
    end
  ...
  class BoundingBox
    ...
    def self.from_json(data)
      out = BoundingBox.new
      out.value = JtdCodegenE2e.from_json(Array[Float], data)
      out
    end
  ...
  class GeojsonObjectFeature < GeojsonObject
    ...
    def self.from_json(data)
      ...
      out.type = "Feature"
      out.geometry = JtdCodegenE2e::from_json(GeojsonObject, data["geometry"])
      out.properties = JtdCodegenE2e::from_json(Hash[String, Object], data["properties"])
      out.id = JtdCodegenE2e::from_json(Object, data["id"])
      out
    end

    def to_json
      data = { "type" => "Feature" }
      data["geometry"] = JtdCodegenE2e::to_json(geometry)
      data["properties"] = JtdCodegenE2e::to_json(properties)
      data["id"] = JtdCodegenE2e::to_json(id) unless id.nil?
      data
    end
  end
  ...
  class GeojsonObjectFeatureCollection < GeojsonObject
    ...
    def self.from_json(data)
      ...
      out.features = JtdCodegenE2e::from_json(Array[GeojsonObject], data["features"])
      out
    end

    def to_json
      data = { "type" => "FeatureCollection" }
      data["features"] = JtdCodegenE2e::to_json(features)
      data
    end
  end
  ...
  class GeojsonObjectGeometryCollection < GeojsonObject
    ...
    def self.from_json(data)
      ...
      out.geometries = JtdCodegenE2e::from_json(Array[GeojsonObject], data["geometries"])
      out.bbox = JtdCodegenE2e::from_json(BoundingBox, data["bbox"])
      out
    end

    def to_json
      data = { "type" => "GeometryCollection" }
      data["geometries"] = JtdCodegenE2e::to_json(geometries)
      data["bbox"] = JtdCodegenE2e::to_json(bbox) unless bbox.nil?
      data
    end
  end
  ...
  class GeojsonObjectLineString < GeojsonObject
    ...
    def self.from_json(data)
      ...
      out.type = "LineString"
      out.coordinates = JtdCodegenE2e::from_json(Array[Position], data["coordinates"])
      out.bbox = JtdCodegenE2e::from_json(BoundingBox, data["bbox"])
      out
    end
    ...
    def to_json
      ...
      data["coordinates"] = JtdCodegenE2e::to_json(coordinates)
      data["bbox"] = JtdCodegenE2e::to_json(bbox) unless bbox.nil?
      data
    end
  end
  ...
  class GeojsonObjectMultiPolygon < GeojsonObject
    ...
    def self.from_json(data)
      ...
      out.coordinates = JtdCodegenE2e::from_json(Array[LinearRing], data["coordinates"])
      out.bbox = JtdCodegenE2e::from_json(BoundingBox, data["bbox"])
      out
    end
  ...
  class GeojsonObjectPoint < GeojsonObject
    ...
    def self.from_json(data)
      ...
      out.type = "Point"
      out.coordinates = JtdCodegenE2e::from_json(Position, data["coordinates"])
      out.bbox = JtdCodegenE2e::from_json(BoundingBox, data["bbox"])
      out
    end
  ...
  class LinearRing
    ...
    def self.from_json(data)
      out = LinearRing.new
      out.value = JtdCodegenE2e.from_json(Array[Position], data)
      out
    end
