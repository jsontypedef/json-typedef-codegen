...
module JTDCodegenE2E
  ...
  class Root
    ...
    def self.from_json_data(data)
      out = Root.new
      out.value = JTDCodegenE2E.from_json_data(GeojsonObject, data)
      out
    end
  ...
  class BoundingBox
    ...
    def self.from_json_data(data)
      out = BoundingBox.new
      out.value = JTDCodegenE2E.from_json_data(Array[Float], data)
      out
    end
  ...
  class GeojsonObjectFeature < GeojsonObject
    ...
    def self.from_json_data(data)
      out = GeojsonObjectFeature.new
      out.type = "Feature"
      out.geometry = JTDCodegenE2E::from_json_data(GeojsonObject, data["geometry"])
      out.properties = JTDCodegenE2E::from_json_data(Hash[String, Object], data["properties"])
      out.id = JTDCodegenE2E::from_json_data(Object, data["id"])
      out
    end

    def to_json_data
      data = { "type" => "Feature" }
      data["geometry"] = JTDCodegenE2E::to_json_data(geometry)
      data["properties"] = JTDCodegenE2E::to_json_data(properties)
      data["id"] = JTDCodegenE2E::to_json_data(id) unless id.nil?
      data
    end
  end
  ...
  class GeojsonObjectFeatureCollection < GeojsonObject
    ...
    def self.from_json_data(data)
      out = GeojsonObjectFeatureCollection.new
      out.type = "FeatureCollection"
      out.features = JTDCodegenE2E::from_json_data(Array[GeojsonObject], data["features"])
      out
    end

    def to_json_data
      data = { "type" => "FeatureCollection" }
      data["features"] = JTDCodegenE2E::to_json_data(features)
      data
    end
  end
  ...
  class GeojsonObjectGeometryCollection < GeojsonObject
    ...
    def self.from_json_data(data)
      out = GeojsonObjectGeometryCollection.new
      out.type = "GeometryCollection"
      out.geometries = JTDCodegenE2E::from_json_data(Array[GeojsonObject], data["geometries"])
      out.bbox = JTDCodegenE2E::from_json_data(BoundingBox, data["bbox"])
      out
    end

    def to_json_data
      data = { "type" => "GeometryCollection" }
      data["geometries"] = JTDCodegenE2E::to_json_data(geometries)
      data["bbox"] = JTDCodegenE2E::to_json_data(bbox) unless bbox.nil?
      data
    end
  end
  ...
  class GeojsonObjectLineString < GeojsonObject
    ...
    def self.from_json_data(data)
      out = GeojsonObjectLineString.new
      out.type = "LineString"
      out.coordinates = JTDCodegenE2E::from_json_data(Array[Position], data["coordinates"])
      out.bbox = JTDCodegenE2E::from_json_data(BoundingBox, data["bbox"])
      out
    end
    ...
    def to_json_data
      ...
      data["coordinates"] = JTDCodegenE2E::to_json_data(coordinates)
      data["bbox"] = JTDCodegenE2E::to_json_data(bbox) unless bbox.nil?
      data
    end
  end
  ...
  class GeojsonObjectMultiLineString < GeojsonObject
    ...
    def self.from_json_data(data)
      out = GeojsonObjectMultiLineString.new
  ...
  class GeojsonObjectMultiPoint < GeojsonObject
    ...
    def self.from_json_data(data)
      out = GeojsonObjectMultiPoint.new
      out.type = "MultiPoint"
      out.coordinates = JTDCodegenE2E::from_json_data(Array[Position], data["coordinates"])
      out.bbox = JTDCodegenE2E::from_json_data(BoundingBox, data["bbox"])
      out
  ...
  class GeojsonObjectMultiPolygon < GeojsonObject
    ...
    def self.from_json_data(data)
      out = GeojsonObjectMultiPolygon.new
      out.type = "MultiPolygon"
      out.coordinates = JTDCodegenE2E::from_json_data(Array[LinearRing], data["coordinates"])
      out.bbox = JTDCodegenE2E::from_json_data(BoundingBox, data["bbox"])
      out
    end
  ...
  class GeojsonObjectPoint < GeojsonObject
    ...
    def self.from_json_data(data)
      out = GeojsonObjectPoint.new
      out.type = "Point"
      out.coordinates = JTDCodegenE2E::from_json_data(Position, data["coordinates"])
      out.bbox = JTDCodegenE2E::from_json_data(BoundingBox, data["bbox"])
      out
    end
  ...
  class LinearRing
    ...
    def self.from_json_data(data)
      out = LinearRing.new
      out.value = JTDCodegenE2E.from_json_data(Array[Position], data)
      out
    end
