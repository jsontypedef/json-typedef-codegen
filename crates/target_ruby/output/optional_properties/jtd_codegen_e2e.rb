...
module JtdCodegenE2e
  ...
  class Root
    ...
    def self.from_json(data)
      out = Root.new
      out.bar = JtdCodegenE2e::from_json(Array[String], data["bar"])
      out.baz = JtdCodegenE2e::from_json(TrueClass, data["baz"])
      out.foo = JtdCodegenE2e::from_json(String, data["foo"])
      out
    end

    def to_json
      data = {}
      data["bar"] = JtdCodegenE2e::to_json(bar) unless bar.nil?
      data["baz"] = JtdCodegenE2e::to_json(baz) unless baz.nil?
      data["foo"] = JtdCodegenE2e::to_json(foo) unless foo.nil?
      data
    end
  end
