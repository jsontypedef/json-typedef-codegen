...
module JTDCodegenE2E
  ...
  class Root
    ...
    def self.from_json_data(data)
      out = Root.new
      out.for_ = JTDCodegenE2E::from_json_data(For, data["for"])
      out.object = JTDCodegenE2E::from_json_data(Object, data["object"])
      out
    end

    def to_json_data
      data = {}
      data["for"] = JTDCodegenE2E::to_json_data(for_)
      data["object"] = JTDCodegenE2E::to_json_data(object)
      data
    end
  end
