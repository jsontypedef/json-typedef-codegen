...
module JtdCodegenE2e
  ...
  class Root
    ...
    def self.from_json(data)
      out = Root.new
      out.for_ = JtdCodegenE2e::from_json(For, data["for"])
      out.object = JtdCodegenE2e::from_json(Object, data["object"])
      out
    end

    def to_json
      data = {}
      data["for"] = JtdCodegenE2e::to_json(for_)
      data["object"] = JtdCodegenE2e::to_json(object)
      data
    end
  end
