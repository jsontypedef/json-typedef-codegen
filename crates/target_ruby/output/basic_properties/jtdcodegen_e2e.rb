...
module JTDCodegenE2E
  ...
  class Root
    ...
    def self.from_json_data(data)
      out = Root.new
      out.bar = JTDCodegenE2E::from_json_data(String, data["bar"])
      out.baz = JTDCodegenE2E::from_json_data(Array[TrueClass], data["baz"])
      out.foo = JTDCodegenE2E::from_json_data(TrueClass, data["foo"])
      out.quux = JTDCodegenE2E::from_json_data(Array[TrueClass], data["quux"])
      out
    end
    ...
    def to_json_data
      ...
      data["quux"] = JTDCodegenE2E::to_json_data(quux)
      data
    end
  end
