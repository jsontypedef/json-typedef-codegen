...
export type GeojsonObject =
	...
	| GeojsonObjectFeatureCollection

	| GeojsonObjectGeometryCollection

	| GeojsonObjectLineString

	| GeojsonObjectMultiLineString

	| GeojsonObjectMultiPoint

	| GeojsonObjectMultiPolygon

	| GeojsonObjectPoint

	| GeojsonObjectPolygon
